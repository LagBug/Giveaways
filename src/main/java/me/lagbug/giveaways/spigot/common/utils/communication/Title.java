package me.lagbug.giveaways.spigot.common.utils.communication;
...
public class Title {
	...
	private static Map<Player, Integer> toSend = new HashMap<>();
	...
	public static void sendForever(Player player, String title, String subtitle) {
		...
		toSend.put(player, Bukkit.getScheduler().scheduleSyncRepeatingTask(CommonUtils.getPlugin(), () -> {
			send(player, 17, title, subtitle);
		}, 0, 40));
    }
